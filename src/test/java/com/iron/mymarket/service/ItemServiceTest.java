...
//        Item item1 = new Item(); item1.setId(1L); item1.setTitle("A"); item1.setPrice(100);
//        Item item2 = new Item(); item2.setId(2L); item2.setTitle("B"); item2.setPrice(200);
//
//        List<Item> items = List.of(item1, item2);
//        Page<Item> page = new PageImpl<>(items);
//
//        when(itemRepository.findAll(PageRequest.of(0, 5, Sort.unsorted()))).thenReturn(page);
...
//
//        Page<ItemDto> result = itemService.findItems("", ItemSort.NO, 1, 5);
//
//        assertEquals(2, result.getContent().size());
//        assertEquals("A", result.getContent().get(0).getTitle());
//        assertEquals("B", result.getContent().get(1).getTitle());
//
//        verify(itemRepository, times(1)).findAll(PageRequest.of(0, 5, Sort.unsorted()));
//    }
//
//    @Test
//    void findItems_withSearch_shouldReturnFilteredItems() {
//        String search = "ball";
//        Item item = new Item(); item.setId(1L); item.setTitle("Ball"); item.setDescription("Round");
...
//
//        Page<ItemDto> result = itemService.findItems(search, ItemSort.NO, 1, 5);
//
//        assertEquals(1, result.getContent().size());
//        assertEquals("Ball", result.getContent().get(0).getTitle());
//
//        verify(itemRepository, times(1))
//                .findByTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase(search, search, PageRequest.of(0, 5, Sort.unsorted()));
//    }
//
//    @Test
//    void findItems_sortByAlpha_shouldReturnSortedPage() {
//        PageRequest pageRequest = PageRequest.of(0, 5, Sort.by("title").ascending());
//        Page<Item> page = new PageImpl<>(List.of());
//
//        when(itemRepository.findAll(pageRequest)).thenReturn(page);
//
//        Page<ItemDto> result = itemService.findItems("", ItemSort.ALPHA, 1, 5);
//
//        assertNotNull(result);
...
//
//    @Test
//    void findItems_sortByPrice_shouldReturnSortedPage() {
//        PageRequest pageRequest = PageRequest.of(0, 5, Sort.by("price").ascending());
//        Page<Item> page = new PageImpl<>(List.of());
//
//        when(itemRepository.findAll(pageRequest)).thenReturn(page);
//
//        Page<ItemDto> result = itemService.findItems("", ItemSort.PRICE, 1, 5);
//
//        assertNotNull(result);
//        verify(itemRepository, times(1)).findAll(pageRequest);
//    }
